...
/* Contact section - vertical stack of slim cards */
.contact-section {
	grid-column: span 2;
	display: flex;
...
/* Social links section - 2 square cards side by side */
.social-section {
	grid-column: span 2;
	display: flex;
	gap: 24px;
...
/* Articles section - vertical stack */
.articles-section {
	grid-column: span 2;
	display: flex;
	flex-direction: column;
